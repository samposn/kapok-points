...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/resources/css/bootstrap-icons@1.5.0/bootstrap-icons.css" />
...
<script src="${ctx}/resources/js/popper@2.9.2/popper.min.js"></script>
<script src="${ctx}/resources/js/bootstrap@5.0.2/bootstrap.min.js"></script>
